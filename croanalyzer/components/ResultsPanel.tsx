...
export function ResultsPanel({
  ...
  // When the diff result is visible, break out of max-w constraint for full-width view
  const diffMode = tab === "rewrite" && rewrite !== null;

  return (
    <div className="animate-fade-in">
      {/* Always-constrained header section */}
      ...
      {/* Tab content — full width in diff mode, constrained otherwise */}
      <div className={diffMode ? "px-4 pb-8" : "max-w-6xl mx-auto px-4 pb-8"}>
        {tab === "overview" && (
